			...
			await api
				...
				.then((response) => {
					if (response.status === 201) {
						showMsg(false, "Cadastro realizado com sucesso!", "/", 5);
					} else {
						showMsg(true, "Oops... algo deu errado!", "/give-classes", 5);
					}
				})
				.catch((error) => {
					console.log(error);
		...
		<div id="page-teacher-form" className="container">
			...
			<main>
				<form onSubmit={handleCreateClass}>
					...
					<footer>
						<p className={formError.status ? "error" : ""}>
